...
parser.add_argument("--save_sample_every", default = 1000, type = int)
parser.add_argument("--save_checkpoint_every", default = 5000, type = int)
parser.add_argument("--save_likelihood_every", default = 5000, type=int)
